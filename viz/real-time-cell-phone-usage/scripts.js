(function() {
  ...
  var starting = moment().startOf('day').subtract(30, 'days').valueOf();

  firebase.database().ref('/screen-events/oPDifD23ReNh7pSZUfWg2jJlESR2').orderByChild('timestamp').startAt(starting).once('value').then(function(snapshot) {
    console.log('what');
